    ...
    try {
      ...
      if (data) {
        setSettings({
          ...
          show_social_proof: data.show_social_proof !== false,
          enable_chat: data.enable_chat || false,
          enable_wishlist: data.enable_wishlist !== false,
          show_stock_count: data.show_stock_count || false,
          enable_quick_view: data.enable_quick_view !== false,
