-- Fix search path security issue for contact info functions

-- Update encrypt_contact_data function to have secure search path
...
-- Update decrypt_contact_data function to have secure search path
...
-- Update mask_contact_data function to have secure search path
...
-- Update check_contact_rate_limit function to have secure search path  
...
-- Update get_user_contact_info_secure function to have secure search path
...
-- Update update_contact_info_secure function to have secure search path
